...
class JadeDatabase
  ...
  public
    ...
    def backup(source, description=nil)
      begin
    ...
    def restore_latest(target)
      ...
      $stdout.puts format_backup(backup_id, source, timestamp, description)
      $stdout.print "(y/n) "
  ...
  private
    ...
    def format_backup(backup_id, timestamp, source, description)
      "ID: #{backup_id}\nTimestamp: #{timestamp}\nSource: #{source}\n" \
